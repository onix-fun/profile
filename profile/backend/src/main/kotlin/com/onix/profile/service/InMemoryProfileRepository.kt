...
class InMemoryProfileRepository : ProfileRepository {
    ...
    private val capabilities = listOf(
        StoredProviderCapability("content", "posts", "owner_section", listOf("post"), """{"buttonKey":"posts"}""", true),
    ...
    private val navButtons = listOf(
        ...
        StoredNavButton("posts", "content", "posts", "posts", "Posts", "pi pi-th-large", "#111827", "canvas", "section", null, null, null, "posts", 20, true),
